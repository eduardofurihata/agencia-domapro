...
### Abertura
Depois de anos no campo e **mais de 2.500 alunos formados**, o domador André Pedroso reúne sua experiência prática no **Doma Pro**.

O Doma Pro é uma assinatura criada para quem quer aprender doma com **método, técnicas e segurança**.

Aqui, o assinante entende o porquê de cada etapa, antes de exigir qualquer coisa do animal.
...
| Item | Detalhe |
|------|---------|
| **Ticket padrão** | **R$ 69/mês** |
| **Ticket alunos André Pedroso** | **R$ 49/mês** (preço especial por tempo limitado) |
| Micro-ancoragem | R$ 2,30/dia (padrão) / R$ 1,63/dia (alunos) |
| Meta 1M/ano | ~1.200 assinantes a R$ 69/mês |
| Checkout | Eduzz |
| Área de membros | Astron Members |

### Posição na Esteira
O Doma Pro é a **porta de entrada** do ecossistema. Estrutura futura:

```
[DOMA PRO R$ 69/mês] - Fase inicial
        ↓
   Assinante engajado
        ↓
   Upsells futuros:
...
- **"O André Pedroso no seu bolso"**

### 🎯 Trilha 1 - Fundamentos da Doma
**Essa é a porta de entrada. Todo mundo começa aqui.**

| Aula | Conteúdo |
|------|----------|
| Apresentação André Pedroso | Quem é o André e sua visão sobre doma |
| Visão sobre doma | Filosofia e abordagem |
| Correção de erros comuns na lida | O que evitar desde o início |
| Ferramentas | Bridões, rédeas e freios |
| Dessensibilização | Bandeira, lona, corda, maneia |
| Primeira Sela / Primeira Montada | Preparação e execução segura |
| Guiar e Equilibrar o Cavalo | Fundamentos de condução |
| Nuca | Flexão e controle |
| Paleta | Movimentação lateral |
| Costela | Controle corporal |
| Garupa | Controle traseiro |
| Início de Manobras | Primeiros passos |
| Trato e manejo dia a dia | Rotina prática |
| Noções Básicas de Casqueamento e Ferrageamento | Cuidados essenciais |

**"Você entende o porquê de cada etapa, antes de exigir qualquer coisa do animal."**

### 📜 Certificado de Conclusão
Ao completar a trilha, o membro recebe o **Certificado de Domador pelo Método André**.
...
### Para Quem É o Doma Pro
- ✓ Para quem **trabalha com cavalo**
- ✓ Para quem quer **domar com segurança**
...
| Critério | Aplicação |
|----------|-----------|
| **Específico** | Doma de cavalos - do trabalho de chão até rédea |
| **Mensurável** | Etapas claras de progresso (abaixo) |
| **Atingível** | Passo a passo sem pular etapa, no ritmo do cavalo e do aluno |
| **Relevante** | Cavalo mais leve, confiante e seguro para qualquer finalidade |
| **Temporal** | Acompanhamento contínuo enquanto for assinante |

### Etapas Mensuráveis de Progresso
- ✓ Cavalo com atenção e foco no treinador
- ✓ Dessensibilizado (aceita bandeira, lona, corda, maneia)
- ✓ Respondendo à pressão e alívio
- ✓ Aceitando sela sem reação
- ✓ Primeira montada segura
- ✓ Respondendo ao bridão e rédea
- ✓ Corpo organizado (nuca, paleta, costela, garupa)

### Por Que Assinar (e não só comprar aula avulsa)
...
| | |
|--|--|
| ~~De R$ 2.785/ano~~ | Ancoragem |
| **R$ 69/mês** | Preço mensal |
| **R$ 2,30/dia** | Menos que um café |

---

**Preço Especial para Alunos do André Pedroso:**
| | |
|--|--|
| ~~R$ 69/mês~~ | Preço padrão |
| **R$ 49/mês** | Preço especial alunos |
| **R$ 1,63/dia** | Menos que um café |
...
### "É caro"
R$ 69/mês (ou R$ 49 pra quem já é aluno) é menos que uma saca de ração. Você investe milhares no cavalo - investir R$ 2,30/dia no conhecimento pra domar ele direito é o que faz diferença no resultado.
...
Pode até conseguir, mas em quanto tempo? Com quantos erros? O Doma Pro encurta o caminho - você aprende o que funciona, evita o que não funciona, e ainda tem o André e a comunidade pra tirar dúvida.

---

## 6. Estrutura da Página de Vendas

> **Estrutura proposta pela Carol:**
> 1. Quem é André Pedroso
> 2. Pra quem é o Doma Pro
> 3. O que o aluno vai aprender (trilhas)
> 4. Benefícios da assinatura
> 5. Valor
> 6. CTA
...
**Depoimento rápido:** "Entrei achando que era só aula. Descobri uma família de gente que vive cavalo igual eu." - [Nome do membro]

---

### 6. Seção "André Pedroso" - Autoridade + proximidade

**Headline:** "Acesso direto ao domador André Pedroso. Sem intermediário."
...
**Quote do André Pedroso:**
> "Eu não estou aqui pra vender e sumir. Estou aqui pra construir domador. Toda semana eu apareço no grupo, respondo, mostro. A gente evolui junto."

---

### 7. Seção "Trilhas" - O que o aluno vai aprender

**Headline:** "Trilha de aprendizado completa. Você avança no seu ritmo."

**Destaque visual:** 🎯 TRILHA 1 - FUNDAMENTOS DA DOMA

**O que você aprende:**
- Apresentação André Pedroso
- Visão sobre doma
- Correção de erros comuns na lida
- Ferramentas (bridões, rédeas e freios)
- Dessensibilização
- Primeira Sela / Primeira Montada
- Guiar e Equilibrar o Cavalo
- Nuca, Paleta, Costela, Garupa
- Início de Manobras
- Trato e manejo dia a dia
- Noções Básicas de Casqueamento e Ferrageamento
- Certificado de conclusão

**Fechamento:** "Você entende o porquê de cada etapa, antes de exigir qualquer coisa do animal."
...
| Separado | Doma Pro |
|----------|----------|
| ~~R$ 2.785/ano~~ | **R$ 69/mês** |

**Preço em destaque:**
# R$ 69/mês
**Cancele quando quiser**

**Microcopy:** "R$ 2,30 por dia. Menos que um café."

---

**OFERTA ESPECIAL PARA ALUNOS DO ANDRÉ PEDROSO:**
# R$ 49/mês
> "Para os alunos, esse preço especial até o dia [DATA]"
...
🔓 **Cancele quando quiser**
O assinante pode cancelar quando quiser, mantendo acesso até o final do ciclo vigente.
...
Sim. Ele está no grupo do WhatsApp e nas lives. Responde dúvidas, dá feedback, acompanha sua evolução.
...
## 7. Próximos Passos para Lançar

### Fase 1: Preparação

| Tarefa | Descrição |
|--------|-----------|
| Configurar Astron Members | Criar área de membros, subir trilhas de aprendizado, personalizar visual |
| Configurar Eduzz | Checkout e cobrança recorrente |
| Criar grupo WhatsApp | Grupo fechado para assinantes |
| Gravar vídeo de vendas | André gravando o pitch ("Fala primos...") |

### Fase 2: Página de Vendas

| Tarefa | Descrição |
|--------|-----------|
| Construir landing page | Seguir estrutura da seção 6 |
| Escrever copy | Headlines, bullets, objeções |
...
| Tarefa | Descrição |
|--------|-----------|
| Definir estratégia | Lançamento aberto, perpétuo ou com janelas? |
| Aquecer audiência | Stories, posts, lives de pré-lançamento |
| Abrir carrinho | CTA em todos os canais |
| Onboarding | Sequência de boas-vindas para novos assinantes |
